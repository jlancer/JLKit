...
@implementation UIDevice (Product_JL)

/**
 *  获取设备名称
*/
+ (const NSString *)jl_getDiviceName {
    return iDeviceNameContainer[[UIDevice transformMachineToIdevice]];
}
...
+ (const NSString *)jl_getInitialVersion {
    return initialFirmwareContainer[[UIDevice transformMachineToIdevice]];
}
...
+ (const NSString *)jl_getLatestVersion {
    return latestFirmwareContainer[[UIDevice transformMachineToIdevice]];
}
...
+ (NSInteger)jl_getBatteryCapacity {
    return BatteryCapacityContainer[[UIDevice transformMachineToIdevice]];
}
...
+ (CGFloat)jl_getBatterVolocity {
    return BatteryVoltageContainer[[UIDevice transformMachineToIdevice]];
}
...
+ (const NSString *)jl_getCPUProcessor {
    return CPUNameContainer[[UIDevice transformMachineToIdevice]];
}
