...
@implementation UIDevice (Info_JL)
...
+ (float)jl_getCPUUsage {
    float cpu = 0;
    NSArray *cpus = [self jl_getPerCPUUsage];
...
+ (int64_t)jl_getUsedDiskSpace {
    int64_t totalDisk = [self jl_getTotalDiskSpace];
    int64_t freeDisk = [self jl_getFreeDiskSpace];
